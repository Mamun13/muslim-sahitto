            ...
            <div className='feedbackBanner section_padding'> 
                <div className='container'>
                    <div className='sectionTitle'>
                        ...
                        <p>বিজয়ের চেতনা লালনের মাধ্যমে যুবকদেরকে দেশ গঠনে এগিয়ে আসতে হবে। এতেই স্বাধীনতা ও বিজয়ের প্রতি সত্যিকার দায়বদ্ধতা রক্ষিত হবে। আমাদের বিজয় ও স্বাধীনতাকে অর্থবহ করার জন্য ব্যক্তি, পরিবার, সমাজ ও রাষ্ট্রের কল্যাণে কাজ করার বিকল্প নেই। সিলেট নগরীর তারুণ্যদীপ্ত সামাজিক সংঘটন ‘চেতনা যুব পরিষদ’-এর উদ্যোগে মহান বিজয় দিবস উপলক্ষে আলোচনা সভা ও দোয়া মাহফিলে বক্তারা একথা বলেন। </p>

                        <div className='cutomeBtn viewAllBtn'>
                            <Link className='goBtn' href="/">সকল বার্তা &nbsp;<BsArrowRightCircle className='newsGoicon'/></Link>
                        </div>
                    </div>
                </div>
             </div>
                ...
                <div className='container'>
                        <Slider {...settings}>
                            ...
                            <div className="card">
                                ...
                                <div className="feedbackText">
                                    <p className="feedback_text_decorate">স্বাধীনতা ও বিজয় আমাদের বহু আকাঙ্খিত স্বপ্ন। দীর্ঘ সংগ্রাম ও ত্যাগের বিনিময়ে আমরা বিজয় অর্জন করেছি। এই বিজয়কে অর্থবহ করতে হলে দেশের কল্যাণে নিজেদের যোগ্যতার বিকাশ ঘটাতে হবে। এজন্য বিজয়ের চেতনায়, মহান মুক্তিযুদ্ধের চেতনায় উদ্বুদ্ধ হওয়ার বিকল্প নেই।</p>
                                </div>
                                <div className="company d-flex justify-content-between">
                                    {/* <Image src={feedbackLogo2} className="companyImg" alt="img"/> */}
                                    {/* <div className="starIcons">
                                        <FaStar className="star"/>
                                        <FaStar className="star"/>
                                        <FaStar className="star"/>
                            ...
                            <div className="card">
                                ...
                                <div className="feedbackText">
                                    <p className="feedback_text_decorate">একটি সভ্য ও মার্জিত জাতি গঠনে বইপাঠেরবিকল্প নেই। যে জাতিযত বেশিবইপড়ে, তারা তত বেশি নিজেদেরকে আলোকিত করতে পারে। আলোকিত সমাজ গঠনে বইপাঠ প্রভাবক হিসেবে ভূমিকা রাখে। কেমুসাসইতিহাস-ঐতিহ্যেরধারাবাহিকতায় সেই সুযোগকরে দিয়েছে। সংসদের উদ্যোগে এগারোদিনব্যাপী ষোড়শ বই মেলার উদ্বোধনী অনুষ্ঠানে প্রধানঅতিথির বক্তব্যে তিনি একথা বলেন।</p>
                                </div>
                                <div className="company d-flex justify-content-between">
                                    {/* <Image src={feedbackLogo3} className="companyImg" alt="img"/> */}
                                    {/* <div className="starIcons">
                                        <FaStar className="star"/>
                                        <FaStar className="star"/>
                                        <FaStar className="star"/>
                            ...
                            <div className="card">
                                ...
                                <div className="feedbackText">
                                    <p className="feedback_text_decorate">হাতের লেখা সুন্দর হওয়াটা সৌন্দর্যময় মনের প্রতিচ্ছবি। আমাদের নতুন প্রজন্ম নতুন আলোয় আলোকিত হয়ে আমাদেরকে নতুন বাংলাদেশ উপহার দেবে। তাদের হাত ধরে বাংলাদেশ ধীরে ধীরে এগিয়ে যাবে। এজন্যে নতুন প্রজন্মকে প্রযুক্তির কুফল থেকে রক্ষা করতে হবে। শিশুরা ফুলের মতো ফুটবে, আজকের শিশুরা আমাদের ঐতিহ্য ও গৌরবকে ছিনিয়ে এনে জাতিকে গৌরবান্বিত করবে।</p>
                                </div>
                                <div className="company d-flex justify-content-between">
                                    {/* <Image src={feedbackLogo2} className="companyImg" alt="img"/> */}
                                    {/* <div className="starIcons">

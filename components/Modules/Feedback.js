        ...
        <div className="container">
          <Slider {...settings}>
            ...
            <div className="card">
              ...
              <div className="feedbackText">
                <p className="feedback_text_decorate">
                  একটি সভ্য ও মার্জিত জাতি গঠনে বইপাঠেরবিকল্প নেই। যে জাতিযত
                  বেশিবইপড়ে, তারা তত বেশি নিজেদেরকে আলোকিত করতে পারে। আলোকিত
                  সমাজ গঠনে বইপাঠ প্রভাবক হিসেবে ভূমিকা রাখে।
                  কেমুসাসইতিহাস-ঐতিহ্যেরধারাবাহিকতায় সেই সুযোগকরে দিয়েছে। সংসদের
                  উদ্যোগে এগারোদিনব্যাপী ষোড়শ বই মেলার উদ্বোধনী অনুষ্ঠানে
                  প্রধানঅতিথির বক্তব্যে তিনি একথা বলেন।
                </p>
              </div>
            </div>
            <div className="card">
